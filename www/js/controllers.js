...
.controller('AppCtrl', function ($scope, $ionicModal, $timeout, BluemixService, appGUID, clientSecret) {
    ...
    $scope.doLogin = function () {
        ...
        BluemixService.connect(appGuid, clientSecret).then(function success(response) {
            //we were successfull and the response contains the deviceID supplied by the Bluemix push service
